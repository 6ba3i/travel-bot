...
const MyAccount: React.FC = () => {
  ...
  const [apiKeys, setApiKeys] = useState<ApiKey[]>([
    { id: '1', name: 'DEEPSEEK_API_KEY', key: '', masked: true },

    { id: '2', name: 'SERPAPI_KEY', key: '', masked: true },

    { id: '3', name: 'FIREBASE_API_KEY', key: '', masked: true },

    { id: '4', name: 'OPENWEATHER_KEY', key: '', masked: true }
